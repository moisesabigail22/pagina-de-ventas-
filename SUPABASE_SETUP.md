...
Si devuelve `SUPABASE_SYNC_VERSION: 2026-02-26-3`, ya estás en el deploy correcto.
...
## Evitar que se repueble la DB cuando hay error de conexión

El cliente ahora **no reseedea** (no vuelve a insertar datos locales) si alguna consulta a Supabase falla.
Así se evita que un error temporal vuelva a crear registros que tú borraste en la base.
